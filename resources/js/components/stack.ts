...
export class StackHelper {
     ...
     */
    static getDisplayClass(display: string): string {
     ...
     */
    static getDirectionClass(direction: string, display: string): string | null {
     ...
     */
    static getGapClass(gap: string, display: string): string | null {
     ...
     */
    static getAlignClass(align: string, display: string): string | null {
        if (display !== 'flex' && display !== 'inline-flex') {
            return null;
        }
     ...
     */
    static getJustifyClass(justify: StackJustify, display: string): string | null {
        if (display !== 'flex' && display !== 'inline-flex') {
            return null;
        }
        if (justify === null) {
    ...
    static generateClasses(props: StackProps): string[] {
        ...
        const classes: (string | null)[] = [
            ...
            display !== 'contents' ? childFullWidth : null,
        ];
    ...
    static validateProps(props: StackProps): { valid: boolean; errors: string[] } {
        ...
        if (props.display !== undefined) {
            const validDisplays: StackDisplay[] = ['flex', 'inline-flex', 'block', 'grid', 'contents'];
