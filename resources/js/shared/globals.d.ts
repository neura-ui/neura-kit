...
interface AlpineGlobal {
    ...
    /* Used by the feature loader to rebuild a subtree whose factory arrived late. */
...
declare global {
    interface Window {
        ...
        /** Set before Livewire loads to disable its DOMContentLoaded auto-start. */
        livewireScriptConfig?: Record<string, unknown>;
