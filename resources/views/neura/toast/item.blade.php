...
>
    <div class="flex items-center">
        ...
        <div class="ml-3 flex-1 w-0">
            <p x-text="toast.content" class="text-sm font-medium leading-5 text-neutral-900 dark:text-white break-words"></p>
        </div>
        ...
        >
            <button
                type="button"
                class="hover:bg-white/5 z-10 p-2 focus:ring-0 rounded-full cursor-pointer text-neutral-400 transition-colors focus:outline-none"
                x-bind:aria-label="window.t('closeNotification', { type: getAriaLabel(toast.type).toLowerCase() })"
            >
