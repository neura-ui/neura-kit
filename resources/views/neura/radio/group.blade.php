...
>
    ...
    @if ($error && filled($error))
        <p
            class="text-neutral-200 bg-red-500 relative w-fit after:content-[''] after:w-1 after:h-full after:bg-white after:absolute after:left-0 after:top-0  text-sm mt-4 px-4 py-0.5"
        >
            {{ $error }}
        </p>
    @endif
