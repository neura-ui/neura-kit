<div class="flex flex-wrap items-center gap-1 p-2 border-b border-edge bg-surface sticky top-0 z-10">
    <div class="flex items-center gap-1 mr-2">
        <button
            type="button"
            x-on:click.prevent="undo()"
            class="p-2 rounded hover:bg-hover transition-colors focus:outline-none text-fg-muted"
            :disabled="!canUndo()"
        >
