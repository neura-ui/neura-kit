    ...
    public static function default(): array
    {
        return [
            'primary' => [
                ...
                'outline' => [
                    'base' => 'border border-primary-300 dark:border-primary-700 bg-white dark:bg-white/[0.03] text-primary-600 [&_svg]:text-primary-600 dark:text-primary-400 dark:[&_svg]:text-primary-400 shadow-sm',
                    'hover' => 'hover:bg-primary-50 dark:hover:bg-primary-500/10',
                ],
                'soft' => [
                    'base' => 'bg-primary-100 dark:bg-primary-500/10 text-primary-700 [&_svg]:text-primary-700 dark:text-primary-400 dark:[&_svg]:text-primary-400',
                    'hover' => 'hover:bg-primary-200 dark:hover:bg-primary-500/15',
                ],
                'ghost' => [
            ...
            'secondary' => [
                ...
                'outline' => [
                    'base' => 'border border-secondary-300 dark:border-secondary-700 bg-white dark:bg-white/[0.03] text-secondary-600 [&_svg]:text-secondary-600 dark:text-secondary-400 dark:[&_svg]:text-secondary-400 shadow-sm',
                    'hover' => 'hover:bg-secondary-50 dark:hover:bg-secondary-500/10',
                ],
                'soft' => [
                    'base' => 'bg-secondary-100 dark:bg-secondary-500/10 text-secondary-700 [&_svg]:text-secondary-700 dark:text-secondary-300 dark:[&_svg]:text-secondary-300',
                    'hover' => 'hover:bg-secondary-200 dark:hover:bg-secondary-500/15',
                ],
                'ghost' => [
                    'base' => 'bg-transparent text-secondary-600 [&_svg]:text-secondary-600 dark:text-secondary-400 dark:[&_svg]:text-secondary-400',
                    'hover' => 'hover:bg-secondary-100 dark:hover:bg-secondary-500/10',
                ],
            ],
            'danger' => [
                'solid' => [
                ...
                'outline' => [
                    'base' => 'border border-danger-300 dark:border-danger-700 bg-white dark:bg-white/[0.03] text-danger-600 [&_svg]:text-danger-600 dark:text-danger-400 dark:[&_svg]:text-danger-400 shadow-sm',
                    'hover' => 'hover:bg-danger-50 dark:hover:bg-danger-500/10',
                ],
                'soft' => [
                    'base' => 'bg-danger-100 dark:bg-danger-500/10 text-danger-700 [&_svg]:text-danger-700 dark:text-danger-400 dark:[&_svg]:text-danger-400',
                    'hover' => 'hover:bg-danger-200 dark:hover:bg-danger-500/15',
                ],
                'ghost' => [
            ...
            'success' => [
                ...
                'outline' => [
                    'base' => 'border border-success-300 dark:border-success-700 bg-white dark:bg-white/[0.03] text-success-600 [&_svg]:text-success-600 dark:text-success-400 dark:[&_svg]:text-success-400 shadow-sm',
                    'hover' => 'hover:bg-success-50 dark:hover:bg-success-500/10',
                ],
                'soft' => [
                    'base' => 'bg-success-100 dark:bg-success-500/10 text-success-700 [&_svg]:text-success-700 dark:text-success-400 dark:[&_svg]:text-success-400',
                    'hover' => 'hover:bg-success-200 dark:hover:bg-success-500/15',
                ],
                'ghost' => [
            ...
            'warning' => [
                ...
                'outline' => [
                    'base' => 'border border-warning-300 dark:border-warning-700 bg-white dark:bg-white/[0.03] text-warning-600 [&_svg]:text-warning-600 dark:text-warning-400 dark:[&_svg]:text-warning-400 shadow-sm',
                    'hover' => 'hover:bg-warning-50 dark:hover:bg-warning-500/10',
                ],
                'soft' => [
                    'base' => 'bg-warning-100 dark:bg-warning-500/10 text-warning-700 [&_svg]:text-warning-700 dark:text-warning-400 dark:[&_svg]:text-warning-400',
                    'hover' => 'hover:bg-warning-200 dark:hover:bg-warning-500/15',
                ],
                'ghost' => [
            ...
            'info' => [
                ...
                'outline' => [
                    'base' => 'border border-info-300 dark:border-info-700 bg-white dark:bg-white/[0.03] text-info-600 [&_svg]:text-info-600 dark:text-info-400 dark:[&_svg]:text-info-400 shadow-sm',
                    'hover' => 'hover:bg-info-50 dark:hover:bg-info-500/10',
                ],
                'soft' => [
                    'base' => 'bg-info-100 dark:bg-info-500/10 text-info-700 [&_svg]:text-info-700 dark:text-info-400 dark:[&_svg]:text-info-400',
                    'hover' => 'hover:bg-info-200 dark:hover:bg-info-500/15',
                ],
                'ghost' => [
    ...
    public static function tailwindColors(): array
    {
        return [
            'slate' => [
                ...
                'outline' => [
                    'base' => 'border border-slate-300 dark:border-slate-700 bg-white dark:bg-white/[0.03] text-slate-600 [&_svg]:text-slate-600 dark:text-slate-400 dark:[&_svg]:text-slate-400 shadow-sm',
                    'hover' => 'hover:bg-slate-50 dark:hover:bg-slate-500/10',
                ],
                'soft' => [
                    'base' => 'bg-slate-100 dark:bg-slate-500/10 text-slate-700 [&_svg]:text-slate-700 dark:text-slate-400 dark:[&_svg]:text-slate-400',
                    'hover' => 'hover:bg-slate-200 dark:hover:bg-slate-500/15',
                ],
                'ghost' => [
            ...
            'gray' => [
                ...
                'outline' => [
                    'base' => 'border border-gray-300 dark:border-gray-700 bg-white dark:bg-white/[0.03] text-gray-600 [&_svg]:text-gray-600 dark:text-gray-400 dark:[&_svg]:text-gray-400 shadow-sm',
                    'hover' => 'hover:bg-gray-50 dark:hover:bg-gray-500/10',
                ],
                'soft' => [
                    'base' => 'bg-gray-100 dark:bg-gray-500/10 text-gray-700 [&_svg]:text-gray-700 dark:text-gray-400 dark:[&_svg]:text-gray-400',
                    'hover' => 'hover:bg-gray-200 dark:hover:bg-gray-500/15',
                ],
                'ghost' => [
            ...
            'zinc' => [
                ...
                'outline' => [
                    'base' => 'border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-white/[0.03] text-zinc-600 [&_svg]:text-zinc-600 dark:text-zinc-400 dark:[&_svg]:text-zinc-400 shadow-sm',
                    'hover' => 'hover:bg-zinc-50 dark:hover:bg-zinc-500/10',
                ],
                'soft' => [
                    'base' => 'bg-zinc-100 dark:bg-zinc-500/10 text-zinc-700 [&_svg]:text-zinc-700 dark:text-zinc-400 dark:[&_svg]:text-zinc-400',
                    'hover' => 'hover:bg-zinc-200 dark:hover:bg-zinc-500/15',
                ],
                'ghost' => [
            ...
            'neutral' => [
                ...
                'outline' => [
                    'base' => 'border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-white/[0.03] text-neutral-600 [&_svg]:text-neutral-600 dark:text-neutral-400 dark:[&_svg]:text-neutral-400 shadow-sm',
                    'hover' => 'hover:bg-neutral-50 dark:hover:bg-white/[0.06]',
                ],
                'soft' => [
                    'base' => 'bg-neutral-100 dark:bg-white/[0.06] text-neutral-700 [&_svg]:text-neutral-700 dark:text-neutral-300 dark:[&_svg]:text-neutral-300',
                    'hover' => 'hover:bg-neutral-200 dark:hover:bg-white/[0.10]',
                ],
                'ghost' => [
                    'base' => 'bg-transparent text-neutral-600 [&_svg]:text-neutral-600 dark:text-neutral-400 dark:[&_svg]:text-neutral-400',
                    'hover' => 'hover:bg-neutral-100 dark:hover:bg-white/[0.06]',
                ],
            ],
            'stone' => [
                'solid' => [
                ...
                'outline' => [
                    'base' => 'border border-stone-300 dark:border-stone-700 bg-white dark:bg-white/[0.03] text-stone-600 [&_svg]:text-stone-600 dark:text-stone-400 dark:[&_svg]:text-stone-400 shadow-sm',
                    'hover' => 'hover:bg-stone-50 dark:hover:bg-stone-500/10',
                ],
                'soft' => [
                    'base' => 'bg-stone-100 dark:bg-stone-500/10 text-stone-700 [&_svg]:text-stone-700 dark:text-stone-400 dark:[&_svg]:text-stone-400',
                    'hover' => 'hover:bg-stone-200 dark:hover:bg-stone-500/15',
                ],
                'ghost' => [
            ...
            'red' => [
                ...
                'outline' => [
                    'base' => 'border border-red-300 dark:border-red-700 bg-white dark:bg-white/[0.03] text-red-600 [&_svg]:text-red-600 dark:text-red-400 dark:[&_svg]:text-red-400 shadow-sm',
                    'hover' => 'hover:bg-red-50 dark:hover:bg-red-500/10',
                ],
                'soft' => [
                    'base' => 'bg-red-100 dark:bg-red-500/10 text-red-700 [&_svg]:text-red-700 dark:text-red-400 dark:[&_svg]:text-red-400',
                    'hover' => 'hover:bg-red-200 dark:hover:bg-red-500/15',
                ],
                'ghost' => [
            ...
            'orange' => [
                ...
                'outline' => [
                    'base' => 'border border-orange-300 dark:border-orange-700 bg-white dark:bg-white/[0.03] text-orange-600 [&_svg]:text-orange-600 dark:text-orange-400 dark:[&_svg]:text-orange-400 shadow-sm',
                    'hover' => 'hover:bg-orange-50 dark:hover:bg-orange-500/10',
                ],
                'soft' => [
                    'base' => 'bg-orange-100 dark:bg-orange-500/10 text-orange-700 [&_svg]:text-orange-700 dark:text-orange-400 dark:[&_svg]:text-orange-400',
                    'hover' => 'hover:bg-orange-200 dark:hover:bg-orange-500/15',
                ],
                'ghost' => [
            ...
            'amber' => [
                ...
                'outline' => [
                    'base' => 'border border-amber-300 dark:border-amber-700 bg-white dark:bg-white/[0.03] text-amber-600 [&_svg]:text-amber-600 dark:text-amber-400 dark:[&_svg]:text-amber-400 shadow-sm',
                    'hover' => 'hover:bg-amber-50 dark:hover:bg-amber-500/10',
                ],
                'soft' => [
                    'base' => 'bg-amber-100 dark:bg-amber-500/10 text-amber-700 [&_svg]:text-amber-700 dark:text-amber-400 dark:[&_svg]:text-amber-400',
                    'hover' => 'hover:bg-amber-200 dark:hover:bg-amber-500/15',
                ],
                'ghost' => [
            ...
            'yellow' => [
                ...
                'outline' => [
                    'base' => 'border border-yellow-300 dark:border-yellow-700 bg-white dark:bg-white/[0.03] text-yellow-600 [&_svg]:text-yellow-600 dark:text-yellow-400 dark:[&_svg]:text-yellow-400 shadow-sm',
                    'hover' => 'hover:bg-yellow-50 dark:hover:bg-yellow-500/10',
                ],
                'soft' => [
                    'base' => 'bg-yellow-100 dark:bg-yellow-500/10 text-yellow-700 [&_svg]:text-yellow-700 dark:text-yellow-400 dark:[&_svg]:text-yellow-400',
                    'hover' => 'hover:bg-yellow-200 dark:hover:bg-yellow-500/15',
                ],
                'ghost' => [
            ...
            'lime' => [
                ...
                'outline' => [
                    'base' => 'border border-lime-300 dark:border-lime-700 bg-white dark:bg-white/[0.03] text-lime-600 [&_svg]:text-lime-600 dark:text-lime-400 dark:[&_svg]:text-lime-400 shadow-sm',
                    'hover' => 'hover:bg-lime-50 dark:hover:bg-lime-500/10',
                ],
                'soft' => [
                    'base' => 'bg-lime-100 dark:bg-lime-500/10 text-lime-700 [&_svg]:text-lime-700 dark:text-lime-400 dark:[&_svg]:text-lime-400',
                    'hover' => 'hover:bg-lime-200 dark:hover:bg-lime-500/15',
                ],
                'ghost' => [
            ...
            'green' => [
                ...
                'outline' => [
                    'base' => 'border border-green-300 dark:border-green-700 bg-white dark:bg-white/[0.03] text-green-600 [&_svg]:text-green-600 dark:text-green-400 dark:[&_svg]:text-green-400 shadow-sm',
                    'hover' => 'hover:bg-green-50 dark:hover:bg-green-500/10',
                ],
                'soft' => [
                    'base' => 'bg-green-100 dark:bg-green-500/10 text-green-700 [&_svg]:text-green-700 dark:text-green-400 dark:[&_svg]:text-green-400',
                    'hover' => 'hover:bg-green-200 dark:hover:bg-green-500/15',
                ],
                'ghost' => [
            ...
            'emerald' => [
                ...
                'outline' => [
                    'base' => 'border border-emerald-300 dark:border-emerald-700 bg-white dark:bg-white/[0.03] text-emerald-600 [&_svg]:text-emerald-600 dark:text-emerald-400 dark:[&_svg]:text-emerald-400 shadow-sm',
                    'hover' => 'hover:bg-emerald-50 dark:hover:bg-emerald-500/10',
                ],
                'soft' => [
                    'base' => 'bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 [&_svg]:text-emerald-700 dark:text-emerald-400 dark:[&_svg]:text-emerald-400',
                    'hover' => 'hover:bg-emerald-200 dark:hover:bg-emerald-500/15',
                ],
                'ghost' => [
            ...
            'teal' => [
                ...
                'outline' => [
                    'base' => 'border border-teal-300 dark:border-teal-700 bg-white dark:bg-white/[0.03] text-teal-600 [&_svg]:text-teal-600 dark:text-teal-400 dark:[&_svg]:text-teal-400 shadow-sm',
                    'hover' => 'hover:bg-teal-50 dark:hover:bg-teal-500/10',
                ],
                'soft' => [
                    'base' => 'bg-teal-100 dark:bg-teal-500/10 text-teal-700 [&_svg]:text-teal-700 dark:text-teal-400 dark:[&_svg]:text-teal-400',
                    'hover' => 'hover:bg-teal-200 dark:hover:bg-teal-500/15',
                ],
                'ghost' => [
            ...
            'cyan' => [
                ...
                'outline' => [
                    'base' => 'border border-cyan-300 dark:border-cyan-700 bg-white dark:bg-white/[0.03] text-cyan-600 [&_svg]:text-cyan-600 dark:text-cyan-400 dark:[&_svg]:text-cyan-400 shadow-sm',
                    'hover' => 'hover:bg-cyan-50 dark:hover:bg-cyan-500/10',
                ],
                'soft' => [
                    'base' => 'bg-cyan-100 dark:bg-cyan-500/10 text-cyan-700 [&_svg]:text-cyan-700 dark:text-cyan-400 dark:[&_svg]:text-cyan-400',
                    'hover' => 'hover:bg-cyan-200 dark:hover:bg-cyan-500/15',
                ],
                'ghost' => [
            ...
            'sky' => [
                ...
                'outline' => [
                    'base' => 'border border-sky-300 dark:border-sky-700 bg-white dark:bg-white/[0.03] text-sky-600 [&_svg]:text-sky-600 dark:text-sky-400 dark:[&_svg]:text-sky-400 shadow-sm',
                    'hover' => 'hover:bg-sky-50 dark:hover:bg-sky-500/10',
                ],
                'soft' => [
                    'base' => 'bg-sky-100 dark:bg-sky-500/10 text-sky-700 [&_svg]:text-sky-700 dark:text-sky-400 dark:[&_svg]:text-sky-400',
                    'hover' => 'hover:bg-sky-200 dark:hover:bg-sky-500/15',
                ],
                'ghost' => [
            ...
            'blue' => [
                ...
                'outline' => [
                    'base' => 'border border-blue-300 dark:border-blue-700 bg-white dark:bg-white/[0.03] text-blue-600 [&_svg]:text-blue-600 dark:text-blue-400 dark:[&_svg]:text-blue-400 shadow-sm',
                    'hover' => 'hover:bg-blue-50 dark:hover:bg-blue-500/10',
                ],
                'soft' => [
                    'base' => 'bg-blue-100 dark:bg-blue-500/10 text-blue-700 [&_svg]:text-blue-700 dark:text-blue-400 dark:[&_svg]:text-blue-400',
                    'hover' => 'hover:bg-blue-200 dark:hover:bg-blue-500/15',
                ],
                'ghost' => [
            ...
            'indigo' => [
                ...
                'outline' => [
                    'base' => 'border border-indigo-300 dark:border-indigo-700 bg-white dark:bg-white/[0.03] text-indigo-600 [&_svg]:text-indigo-600 dark:text-indigo-400 dark:[&_svg]:text-indigo-400 shadow-sm',
                    'hover' => 'hover:bg-indigo-50 dark:hover:bg-indigo-500/10',
                ],
                'soft' => [
                    'base' => 'bg-indigo-100 dark:bg-indigo-500/10 text-indigo-700 [&_svg]:text-indigo-700 dark:text-indigo-400 dark:[&_svg]:text-indigo-400',
                    'hover' => 'hover:bg-indigo-200 dark:hover:bg-indigo-500/15',
                ],
                'ghost' => [
            ...
            'violet' => [
                ...
                'outline' => [
                    'base' => 'border border-violet-300 dark:border-violet-700 bg-white dark:bg-white/[0.03] text-violet-600 [&_svg]:text-violet-600 dark:text-violet-400 dark:[&_svg]:text-violet-400 shadow-sm',
                    'hover' => 'hover:bg-violet-50 dark:hover:bg-violet-500/10',
                ],
                'soft' => [
                    'base' => 'bg-violet-100 dark:bg-violet-500/10 text-violet-700 [&_svg]:text-violet-700 dark:text-violet-400 dark:[&_svg]:text-violet-400',
                    'hover' => 'hover:bg-violet-200 dark:hover:bg-violet-500/15',
                ],
                'ghost' => [
            ...
            'purple' => [
                ...
                'outline' => [
                    'base' => 'border border-purple-300 dark:border-purple-700 bg-white dark:bg-white/[0.03] text-purple-600 [&_svg]:text-purple-600 dark:text-purple-400 dark:[&_svg]:text-purple-400 shadow-sm',
                    'hover' => 'hover:bg-purple-50 dark:hover:bg-purple-500/10',
                ],
                'soft' => [
                    'base' => 'bg-purple-100 dark:bg-purple-500/10 text-purple-700 [&_svg]:text-purple-700 dark:text-purple-400 dark:[&_svg]:text-purple-400',
                    'hover' => 'hover:bg-purple-200 dark:hover:bg-purple-500/15',
                ],
                'ghost' => [
            ...
            'fuchsia' => [
                ...
                'outline' => [
                    'base' => 'border border-fuchsia-300 dark:border-fuchsia-700 bg-white dark:bg-white/[0.03] text-fuchsia-600 [&_svg]:text-fuchsia-600 dark:text-fuchsia-400 dark:[&_svg]:text-fuchsia-400 shadow-sm',
                    'hover' => 'hover:bg-fuchsia-50 dark:hover:bg-fuchsia-500/10',
                ],
                'soft' => [
                    'base' => 'bg-fuchsia-100 dark:bg-fuchsia-500/10 text-fuchsia-700 [&_svg]:text-fuchsia-700 dark:text-fuchsia-400 dark:[&_svg]:text-fuchsia-400',
                    'hover' => 'hover:bg-fuchsia-200 dark:hover:bg-fuchsia-500/15',
                ],
                'ghost' => [
            ...
            'pink' => [
                ...
                'outline' => [
                    'base' => 'border border-pink-300 dark:border-pink-700 bg-white dark:bg-white/[0.03] text-pink-600 [&_svg]:text-pink-600 dark:text-pink-400 dark:[&_svg]:text-pink-400 shadow-sm',
                    'hover' => 'hover:bg-pink-50 dark:hover:bg-pink-500/10',
                ],
                'soft' => [
                    'base' => 'bg-pink-100 dark:bg-pink-500/10 text-pink-700 [&_svg]:text-pink-700 dark:text-pink-400 dark:[&_svg]:text-pink-400',
                    'hover' => 'hover:bg-pink-200 dark:hover:bg-pink-500/15',
                ],
                'ghost' => [
            ...
            'rose' => [
                ...
                'outline' => [
                    'base' => 'border border-rose-300 dark:border-rose-700 bg-white dark:bg-white/[0.03] text-rose-600 [&_svg]:text-rose-600 dark:text-rose-400 dark:[&_svg]:text-rose-400 shadow-sm',
                    'hover' => 'hover:bg-rose-50 dark:hover:bg-rose-500/10',
                ],
                'soft' => [
                    'base' => 'bg-rose-100 dark:bg-rose-500/10 text-rose-700 [&_svg]:text-rose-700 dark:text-rose-400 dark:[&_svg]:text-rose-400',
                    'hover' => 'hover:bg-rose-200 dark:hover:bg-rose-500/15',
                ],
                'ghost' => [
